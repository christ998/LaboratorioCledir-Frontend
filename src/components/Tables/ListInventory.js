...
import {Button, createTheme, TableFooter, TablePagination, ThemeProvider} from "@mui/material";
...
export default function ListInventory(props) {
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <ModalInventory info={infoModal} isOpen={openModal} handleCloseModal={handleCloseModal}/>
